 ...
 * @author visitante
 */
public class frmMantenimientoSede extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<clsSedes> listaSedes = sede.getListadoSedes();
        tablaSedes.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < listaSedes.size(); i++) {
            dato[0] = listaSedes.get(i).getCodigo_sede();
            dato[1] = listaSedes.get(i).getNombre_sede();
            dato[2] = listaSedes.get(i).getEstatus_sede();
            modelo.addRow(dato);
        }       
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsSedes sede = new clsSedes();
        sede.setCodigo_sede(txtbuscado.getText());
        registrosBorrados=sede.setBorrarSede(sede);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsSedes sede = new clsSedes();
        sede.setCodigo_sede(txtCodigo.getText());
        sede.setNombre_sede(txtNombre.getText());
        sede.setEstatus_sede(txtEstatus.getText());
        sede.setIngresarSede(sede);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        sede.setCodigo_sede(txtbuscado.getText());        
        sede= sede .getBuscarInformacionSedesPorId(sede );
        System.out.println("Aplicacion retornado:" + sede );        
        txtNombre.setText(sede.getNombre_sede());
        txtEstatus.setText(sede.getEstatus_sede());
